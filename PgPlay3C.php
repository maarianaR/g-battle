...
<title>G-Battle - Consoles | PlayStation 3</title>
...
<body background="imagens/bg.png">
  <div id="principal" >
   <div id="alinha" >
    <div  id="banner">
    <br />
    <img src="imagens/x.gif" width="952" height="74" border="0" usemap="#Map" href="cadastro.php"/>
    <map name="Map" id="Map">
      <area shape="rect" coords="41,1,359,78" href="index.php" />
      <area shape="rect" coords="715,8,917,62" href="#" />
    </map>
         <?php
  ...
  <br />
        ...
        <map name="Map2" id="Map2">
          <area shape="rect" coords="9,10,232,37" href="PgPlay2.php" />
          <area shape="rect" coords="234,9,407,37" href="PgPlay3.php" />
          <area shape="rect" coords="414,10,645,37" href="PgXBox360.php" />
          <area shape="rect" coords="651,8,804,38" href="PgWii.php" />
          <area shape="rect" coords="813,10,964,36" href="PgPC.php" />
        </map>
                <?php
	...
	<div id="conteudo" >
			...
			$sql = "SELECT * FROM produtos WHERE tipo = 'C' AND console = 'PS3'";
