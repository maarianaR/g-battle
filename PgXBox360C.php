...
<title>G-Battle - Consoles | Xbox 360</title>
...
<body background="imagens/bg.png">
  <div id="principal" >
   <div id="alinha" >
    <div  id="banner">
      <p><br />
        <img src="imagens/x.gif" width="922" height="74" border="0" usemap="#Map"/>
        <map name="Map" id="Map">
          <area shape="rect" coords="38,4,357,79" href="index.php" />
          <area shape="rect" coords="716,8,916,59" href="cadastro.php" />
        </map>
         <?php
	...
	?>
           ...
           <map name="Map2" id="Map2">
             <area shape="rect" coords="3,29,231,59" href="PgPlay2.php" />
             <area shape="rect" coords="239,28,409,58" href="PgPlay3.php" />
             <area shape="rect" coords="418,29,649,57" href="PgXBox360.php" />
             <area shape="rect" coords="663,30,802,57" href="PgWii.php" />
             <area shape="rect" coords="819,35,959,56" href="PgWii.php" />
        </map>
           <br />
           <?php
   ...
   <br /> <br />
	...
	<div id="conteudo" >
			...
			$sql = "SELECT * FROM produtos WHERE tipo = 'C' AND console = 'XBOX 360'";
