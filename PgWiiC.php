...
<title>G-Battle - Consoles | Wii</title>
...
<body background="imagens/bg.png">
  <div id="principal" >
   <div id="alinha" >
    <div  id="banner">
      <p><img src="imagens/x.gif" width="961" height="92" border="0" usemap="#Map"/>
	    <map name="Map" id="Map">
	      <area shape="rect" coords="28,2,373,95" href="index.php" />
	      <area shape="rect" coords="714,5,914,68" href="cadastro.php" />
        </map>
	...
	?>
	  ...
	  <p><img src="imagens/x.gif" width="968" height="74" border="0" usemap="#Map2"/>
	    <map name="Map2" id="Map2">
	      <area shape="rect" coords="7,2,230,25" href="PgPlay2.php" />
	      <area shape="rect" coords="237,4,407,25" href="PgPlay3.php" />
	      <area shape="rect" coords="414,4,645,25" href="PgXBox360.php" />
	      <area shape="rect" coords="655,5,809,26" href="PgWii.php" />
	      <area shape="rect" coords="817,5,965,27" href="PgPC.php" />
        </map>
      </p>
               <?php
	...
	<div id="conteudo" >
			...
			$sql = "SELECT * FROM produtos WHERE tipo = 'C' AND console = 'WII'";
