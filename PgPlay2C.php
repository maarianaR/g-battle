...
<title>G-Battle - Consoles | PlayStation 2</title>
...
<body background="imagens/bg.png">
  <div id="principal" >
   <div id="alinha" >
    <div  id="banner">
	<br />
	<img src="imagens/x.gif" width="942" height="73" border="0" usemap="#Map"/>
    <map name="Map" id="Map">
      <area shape="rect" coords="34,0,380,75" href="index.php" />
      <area shape="rect" coords="712,8,924,63" href="cadastro.php" />
    </map>
         <?php
    ...
    <map name="Map2" id="Map2">
      <area shape="rect" coords="7,5,231,41" href="PgPlay2.php" />
      <area shape="rect" coords="238,3,403,41" href="PgPlay3.php" />
      <area shape="rect" coords="419,3,642,42" href="PgXBox360.php" />
      <area shape="rect" coords="657,5,799,42" href="PgWii.php" />
      <area shape="rect" coords="817,4,957,41" href="PgPC.php" />
    </map>
            <?php
	...
	<div id="conteudo" >
			...
			$sql = "SELECT * FROM produtos WHERE tipo = 'C' AND console = 'PS2'";
