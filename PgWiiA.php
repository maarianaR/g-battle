...
<title>G-Battle - Acessórios | Wii</title>
...
<body background="imagens/bg.png">
  <div id="principal" >
   <div id="alinha" >
    <div  id="banner">
	<br />
	<img src="imagens/x.gif" width="968" height="74" border="0" usemap="#Map"/>
    <map name="Map" id="Map">
      <area shape="rect" coords="24,-1,387,73" href="index.php" />
      <area shape="rect" coords="723,14,918,56" href="cadastro.php" />
    </map>
         <?php
	...
	?>
        ...
        <map name="Map2" id="Map2">
          <area shape="rect" coords="6,3,228,28" href="PgPlay2.php" />
          <area shape="rect" coords="237,6,408,26" href="PgPlay3.php" />
          <area shape="rect" coords="415,7,644,27" href="PgXBox360.php" />
          <area shape="rect" coords="655,8,807,26" href="PgWii.php" />
          <area shape="rect" coords="816,8,965,26" href="PgPC.php" />
        </map>
               <?php
	...
	<div id="conteudo" >
			...
			$sql = "SELECT * FROM produtos WHERE tipo = 'A' AND console = 'WII'";
