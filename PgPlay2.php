...
<title>G-Battle - Jogos | PlayStation 2</title>
...
<body background="imagens/bg.png">
  ...
  <br />
  <img src="imagens/x.gif" width="951" height="73" border="0" usemap="#Map"/>
  <map name="Map" id="Map">
    <area shape="rect" coords="44,-2,373,68" href="index.php" />
    <area shape="rect" coords="711,8,920,65" href="cadastro.php" />
  </map>
	...
	?>
      ...
      <img src="imagens/x.gif" width="981" height="121" border="0" usemap="#Map2"/>
      <map name="Map2" id="Map2">
        <area shape="rect" coords="4,27,229,63" href="PgPlay2.php" />
        <area shape="rect" coords="235,27,408,62" href="PgPlay3.php" />
        <area shape="rect" coords="412,26,645,63" href="PgXBox360.php" />
        <area shape="rect" coords="653,26,807,65" href="PgWii.php" />
        <area shape="rect" coords="814,26,969,67" href="PgPC.php" />
      </map>
            <?php
	...
	<div id="conteudo" >
			...
			$sql = "SELECT * FROM produtos WHERE tipo = 'J' AND console = 'PS2'";
